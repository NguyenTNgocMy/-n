...
class Bangdiem_MonHoc(db.Model):
  diem_id = Column(Integer, ForeignKey(Bang_diem.id), primary_key=True)
  monhoc_id = Column(Integer, ForeignKey(Mon_hoc.id), primary_key=True)



class User_Bangdiem(db.Model):
